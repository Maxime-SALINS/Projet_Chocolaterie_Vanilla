...
<section class="container-fluid my-6">
    ...
    <div class="row justify-content-center">
        <div class="col-12 col-sm-5 text-center my-4 my-sm-1">
...
<section class="container-fluid my-5">
    ...
    <div class="row">
        <div class="col-12 col-lg-6 my-auto">
            <p class="text-description"><?= $newPage->getText(4);?></p>
            <p class="text-description"><?= $newPage->getText(5);?></p>
            <p class="text-description"><?= $newPage->getText(6);?></p>
        </div>
...
<section class="container-fluid my-5">
    ...
    <div class="row">
        <div class="col-12 col-md-6 col-lg-3">
            ...
            <p class="text-description my-4"><?= $newPage->getText(7);?></p>
        </div>
        <div class="col-12 col-md-6 col-lg-3">
            <img class="img-fluid" src="<?= $newPage->getImage(8);?>" alt="<?= $newPage->getAlt(8);?>">
            <p class="text-description my-4"><?= $newPage->getText(8);?></p>
        </div>
        <div class="col-12 col-md-6 col-lg-3">
            <img class="img-fluid" src="<?= $newPage->getImage(9);?>" alt="<?= $newPage->getAlt(9);?>">
            <p class="text-description my-4"><?= $newPage->getText(9);?></p>
        </div>
        <div class="col-12 col-md-6 col-lg-3">
            <img class="img-fluid" src="<?= $newPage->getImage(10);?>" alt="<?= $newPage->getAlt(10);?>">
            <p class="text-description my-4"><?= $newPage->getText(10);?></p>
        </div>
    </div>
</section>