<aside class="filter col-12 col-sm-2 p-0 p-sm-3">
    <div class="d-flex align-items-center justify-content-evenly">
        <h3 class="title-filter text-center my-0 my-sm-3">Filtre</h3>
        <div class="d-block d-sm-none" id="filter_responsive"></div>
    </div>
    <div class="container">
        <form class="px-2 px-sm-0" action="" method="post" id="formFilter">
            ...
            <div class="d-flex justify-content-center my-3">
                <button class="btn btn-product btn-product-small text-white" type="submit">Filtrer</button>
            </div>
        </form>
    </div>
</aside>